            ...
            <div className="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
              ...
              <ul className="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                ...
                <li className="flex items-center pl-4 xl:hidden">
                  <a href="#" className="block p-0 transition-all ease-nav-brand text-sm text-slate-500" data-sidenav-trigger="true">
                ...
                <li className="flex items-center px-4">
                  <a href="#" className="p-0 transition-all text-sm ease-nav-brand text-slate-500">
                    <i data-fixed-plugin-button-nav="true" className="cursor-pointer fa fa-cog"></i>
                  </a>
                </li>
                ...
                <div className="flex-auto p-4">
                  <div className="flex flex-row -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans font-semibold leading-normal text-sm">Today$aposs Money</p>
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div className="flex-auto p-4">
                  <div className="flex flex-row -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans font-semibold leading-normal text-sm">Today$aposs Users</p>
                        <h5 className="mb-0 font-bold">
                          2,300
