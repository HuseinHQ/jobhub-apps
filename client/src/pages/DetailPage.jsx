  ...
  return (
    <div className="flex flex-col w-full p-2 bg-white">
      <div className="flex justify-between pb-5">
        <button className="py-2 px-4 font-semibold bg-[#e60278] hover:bg-[#e6028b] text-white rounded transition-colors">Lamar Sekarang</button>
      ...
      <div className="flex overflow-auto px-8 py-12 w-full">
        <div className="flex flex-col gap-1 w-full">
          ...
          <p className="text-slate-800 -mt-2">{job.jobType}</p>
          ...
          <p className="text-slate-800 -mt-2 mb-10">{"Email: " + job.Company?.email}</p>
