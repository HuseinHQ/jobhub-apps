    ...
    <>
      <div className=" flex py-3 w-full justify-center bg-[#0d3880]">
        <div className="flex w-[90vw] flex-wrap content-center gap-3">
          <input
            className="rounded focus:ring-4 focus:ring-blue-500 focus:outline-none focus:ring-inset-0 py-2 px-4 w-96"
          ...
          />
          <input className="rounded focus:ring-4 focus:ring-blue-500 focus:outline-none focus:ring-inset-0 py-2 px-4 w-96" />
